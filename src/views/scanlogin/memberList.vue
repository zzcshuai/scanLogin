...
<div id="root">
  ...
  <div class="content">
    ...
    <ul class="member-total">
      <li @click='noFilter()'>共:<span>{{memberSum}}</span>人</li>
      <li @click='filterCheckIn()'>已录入:<span>{{entered}}</span>人</li>
      <li @click='filterNoCheck()'>未录入:<span>{{noEnter}}</span>人</li>
    </ul>
    <ul class="member-list">
      <li v-for="(item,index) in pDetail" :key="index" >
        <div>
          <div>
            <!-- <img  v-lazy="defaultImgUrl+item.useridcard__idcard_img" /> -->
